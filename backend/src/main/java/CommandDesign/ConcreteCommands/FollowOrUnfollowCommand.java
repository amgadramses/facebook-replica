...
public class FollowOrUnfollowCommand extends Command {
    ...
    protected void execute() {
        ...
        String modified_user_id = "Users/"+user_id;
        String modified_followed_id = "Users/"+followed_id;
        ...
        if(!cursor.hasNext()){ //follow
            BaseEdgeDocument followed = new BaseEdgeDocument("Users/"+user_id, "Users/"+followed_id);
            try {
